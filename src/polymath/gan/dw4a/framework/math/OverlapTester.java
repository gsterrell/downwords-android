package polymath.gan.dw4a.framework.math;
...
public class OverlapTester {
	...
	public static boolean pointInCircle(Circle c, float x, Vector2 p) {
		return c.center.distSquared(p) < c.radius * c.radius;
	}
	
	public static boolean pointInRectangle(Circle c, float x, float y) {
